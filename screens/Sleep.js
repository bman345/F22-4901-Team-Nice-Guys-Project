...
export default function TrackScreen({ navigation }) {
  ...
  return (
    ...
    <KeyboardAvoidingView style={styles.container} behavior="height">     
      <View style={styles.pickerContainer}>
        <Text style={styles.selectNumberText}>Select number of hours slept:</Text>
        <View style={{ backgroundColor: '#BAEBD9', borderRadius: 10, height: 40, width: 200, top: 0, left: 10 }}>
  ...
  <Text key={index} style={styles.noteOutput}>Note {index + 1}: {output}</Text>
      ...
      <View style={styles.timeContainer}>
        <Text style={styles.selectTimeText}>Select time slept:</Text>
